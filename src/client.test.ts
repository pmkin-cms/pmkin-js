  ...
  describe('findDocument', () => {
    it('should return a document.', async () => {
      const mockDocument = {
        ...
        excerpt: `From the vibrant color explosions of India's Holi to the intricate ice sculptures of Harbin, local festivals offer travelers the rare opportunity to experience culture at its most authentic. These celebrations transform ordinary locations into extraordinary spectacles where traditions centuries old come alive. Beyond mere observation, these festivals invite visitors to participate actively—whether dancing at Rio's Carnival or releasing lanterns at Thailand's Yi Peng—creating connections and memories that standard sightseeing simply cannot match.`,
